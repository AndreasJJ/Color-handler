...
describe('rgb2hwb transformation', () => {
    test('it should transform rgb to hwb and return type depending on output option', () => {
    ...
    test('it should transform rgb to hwb and return a HWB string', () => {
    ...
    test('it should transform rgb to hwb and return a HWB object', () => {
    ...
    test('it should transform rgb to hwb and return a HWB array', () => {
