...
describe('rgba2rgb transformation', () => {
    test('it should transform rgba to rgb and return type depending on output option', () => {
    ...
    test('it should transform rgba to rgb and return a RGB string', () => {
    ...
    test('it should transform rgba to rgb and return a RGB object', () => {
    ...
    test('it should transform rgba to rgb and return a RGB array', () => {
